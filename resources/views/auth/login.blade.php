        ...
        <div class="max-w-lg w-full mx-auto py-8 px-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            ...
            <form action="">
                <div class="w-full md:w-1/4">
                    <a href="" class="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50" role="button">
                        <!-- <img class="w-5 h-5 mr-2" alt="Google sign-in" src=""> -->
                        Login with Google
                    </a>
                </div>
            </form>
